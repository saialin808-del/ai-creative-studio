...
const STEPS = [
  { label: 'ဖန်တီးရန်', sub: 'အကြံအစည်' },
  { label: 'ဇာတ်ကောင်', sub: 'ဇာတ်ကောင်များ ထည့်ရန်', req: [1] },
  { label: 'ဇာတ်လမ်း', sub: 'ဇာတ်လမ်းရေးရန်', req: [1] },
  { label: 'မြင်ကွင်း', sub: 'မြင်ကွင်းဖန်တီးရန်', req: [2] },
  { label: 'အပြီးသတ်', sub: 'နောက်ဆုံးရလဒ်', req: [4] },
];
...
#typeSel,#audSel,#toneSel,#langSel{border-radius:16px;padding:12px 16px;background:rgba(0,229,255,.06);border:1px solid rgba(0,229,255,.18);color:#e8ecf4;min-height:48px;}
#typeSel:hover,#audSel:hover,#toneSel:hover,#langSel:hover{background:rgba(0,229,255,.12);border-color:rgba(0,229,255,.35);}
#audSel{background:rgba(123,92,255,.06);border-color:rgba(123,92,255,.18);}
#audSel:hover{background:rgba(123,92,255,.12);border-color:rgba(123,92,255,.35);}
#toneSel{background:rgba(74,222,128,.06);border-color:rgba(74,222,128,.18);}
#toneSel:hover{background:rgba(74,222,128,.12);border-color:rgba(74,222,128,.35);}
#langSel{background:rgba(255,159,43,.06);border-color:rgba(255,159,43,.18);}
#langSel:hover{background:rgba(255,159,43,.12);border-color:rgba(255,159,43,.35);}
