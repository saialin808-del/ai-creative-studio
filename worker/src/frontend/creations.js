// AI Creative Studio — Creations UI Frontend 
...
.sidebar{position:fixed;left:0;top:0;width:220px;height:100vh;background:var(--bg-sidebar);border-right:1px solid var(--border);padding:24px 14px;overflow-y:auto;z-index:100;transition:transform 0.3s;}
...
.main-content{margin-left:220px;padding:24px;max-width:900px;}
...
<nav class="sidebar" id="sidebar">
  <div class="brand"><div class="brand-title">AICREATIVE</div></div>
  <a class="nav-item" href="/app"><span class="nav-icon-circle">🏠</span> Home</a>
  <div class="nav-label">Studios</div>
  <a class="nav-item" href="/app/story"><span class="nav-icon-circle">📖</span> Story Studio</a>
  <a class="nav-item" href="/app/content"><span class="nav-icon-circle">✍️</span> Content Studio</a>
  <a class="nav-item" href="/app/short"><span class="nav-icon-circle">🎬</span> Short Studio</a>
  <a class="nav-item" href="/app/image"><span class="nav-icon-circle">🎨</span> Image Studio</a>
  <a class="nav-item" href="/app/voice"><span class="nav-icon-circle">🎙</span> Voice Studio</a>
  <a class="nav-item" href="/app/shop"><span class="nav-icon-circle">🛒</span> Shop Studio</a>
  <div class="nav-label">My Work</div>
  <a class="nav-item active" href="/app/creations"><span class="nav-icon-circle">📁</span> Recent Projects</a>
  <div class="sidebar-bottom">
    <div class="license-badge" id="licenseBadge">Checking plan...</div>
    <a class="side-btn" href="/admin">⚙️ Admin Panel</a>
  </div>
</nav>
