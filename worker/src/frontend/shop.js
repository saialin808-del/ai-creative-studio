// AI Creative Studio — Shop Studio Frontend 
...
<div class="layout">
  <nav class="sidebar" id="sidebar">
    ...
    <a href="/app/content"><span class="nav-icon">📝</span> Content</a>
    <a href="/app/story"><span class="nav-icon">📖</span> Story</a>
    <a href="/app/short"><span class="nav-icon">🎬</span> Short</a>
    <a href="/app/image"><span class="nav-icon">🖼️</span> Image</a>
    <a href="/app/voice"><span class="nav-icon">🎙️</span> Voice</a>
    <a href="/app/shop" class="active"><span class="nav-icon">🛒</span> Shop</a>
    <a href="/admin"><span class="nav-icon">⚙️</span> Admin</a>
  </nav>
  <main class="main">
