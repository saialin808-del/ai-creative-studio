...
.sidebar { width:220px; background:#0d1425; border:1.5px solid #eb549e; border-radius:16px; margin:14px 12px; padding:14px 0; flex-shrink:0; box-shadow:0 0 20px rgba(235,84,158,0.15); }
.sidebar a { display:flex; align-items:center; gap:10px; padding:11px 20px; color:var(--text2); font-size:13.5px; transition:all 0.2s; border-left:3px solid transparent; }
.sidebar a:hover { background:rgba(0,229,255,0.06); color:var(--text); }
.sidebar a.active { background:rgba(0,229,255,0.1); color:var(--cyan); border-left-color:var(--cyan); font-weight:600; }
...
<div class="layout">
  <nav class="sidebar" id="sidebar" style="display:flex;flex-direction:column;">
    <a href="/app"><span class="nav-icon">&#127968;</span> ပင်မ</a>
    <div style="font-size:10.5px;color:var(--text3);letter-spacing:1.2px;padding:12px 20px 4px;text-transform:uppercase;">STUDIOS</div>
    <a href="/app/story"><span class="nav-icon">&#128214;</span> ဇာတ်လမ်း</a>
    <a href="/app/content"><span class="nav-icon">&#9997;</span> ကွန်တင့်</a>
    <a href="/app/short"><span class="nav-icon">&#127916;</span> ရှော့တ်</a>
    <a href="/app/image"><span class="nav-icon">&#128444;</span> ဓာတ်ပုံ</a>
    <a href="/app/voice"><span class="nav-icon">&#127908;</span> အသံ</a>
    <a href="/app/shop" class="active"><span class="nav-icon">&#128722;</span> ဈေး</a>
    <div style="font-size:10.5px;color:var(--text3);letter-spacing:1.2px;padding:12px 20px 4px;text-transform:uppercase;">MY WORK</div>
    ...
    <div style="margin-top:auto;padding:14px 12px 4px;border-top:1px solid var(--border);font-size:12px;">
      ...
      <a class="side-btn" id="adminLink" href="/admin" style="display:none;align-items:center;gap:8px;padding:8px 10px;border-left:none;border-radius:8px;background:rgba(123,92,255,0.12);font-size:12.5px;color:var(--purple);margin-bottom:4px;text-decoration:none;">&#9881; Admin Panel</a>
