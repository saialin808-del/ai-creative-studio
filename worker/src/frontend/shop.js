...
// Workflow:
//   Main: 01 Content → 02 AI ရေးသားနေသည် → 03 Shop Content ရလဒ်
//   Branch 03 မှ:  🎬 Video Branch (Content → Video Setup → AI → Video Result)
//                  🔊 Audio Branch (Content → Audio Setup → AI → Audio Result → SRT → Translation)
...
// ===================== MAIN STEP 02 — AI ရေးသားနေသည် (Loading) =====================
const STEP2_HTML = `
<div class="aics-step" data-step="2">
<div class="card">
<div class="shop-loading-card">
<div class="spinner"></div>
<div class="shop-loading-title">&#10024; AI ရေးသားနေသည်...</div>
<div class="shop-status-list" id="contentStatus">
<div class="st-line" data-idx="0"><span class="st-marker">○</span><span>အချက်အလက်များကို ဖတ်နေသည်</span></div>
<div class="st-line" data-idx="1"><span class="st-marker">○</span><span>အကြောင်းအရာကို ခွဲခြမ်းနေသည်</span></div>
<div class="st-line" data-idx="2"><span class="st-marker">○</span><span>Content ရေးသားနေသည်</span></div>
<div class="st-line" data-idx="3"><span class="st-marker">○</span><span>Content ကို စစ်ဆေးနေသည်</span></div>
</div>
...
// ===================== MAIN STEP 03 — Shop Content ရလဒ် + Branch ၂ ခု =====================
const STEP3_HTML = `
...
<div class="card" id="videoLoadingCard" style="display:none;">
<div class="shop-loading-card">
<div class="spinner"></div>
<div class="shop-loading-title">&#10024; AI ပြင်ဆင်နေသည်...</div>
<div class="shop-status-list" id="videoStatus">
<div class="st-line" data-idx="0"><span class="st-marker">○</span><span>အချက်အလက်များကို ဖတ်နေသည်</span></div>
<div class="st-line" data-idx="1"><span class="st-marker">○</span><span>ဇာတ်ကောင်နှင့် Scene များကို ခွဲခြမ်းနေသည်</span></div>
<div class="st-line" data-idx="2"><span class="st-marker">○</span><span>Video ဖန်တီးရန် ပြင်ဆင်နေသည်</span></div>
<div class="st-line" data-idx="3"><span class="st-marker">○</span><span>Result ကို စစ်ဆေးနေသည်</span></div>
</div>
...
<div class="card" id="audioLoadingCard" style="display:none;">
<div class="shop-loading-card">
<div class="spinner"></div>
<div class="shop-loading-title">&#10024; AI အသံဖန်တီးနေသည်...</div>
<div class="shop-status-list" id="audioStatus">
<div class="st-line" data-idx="0"><span class="st-marker">○</span><span>အချက်အလက်များကို ဖတ်နေသည်</span></div>
<div class="st-line" data-idx="1"><span class="st-marker">○</span><span>အသံအကြောင်းအရာကို ခွဲခြမ်းနေသည်</span></div>
<div class="st-line" data-idx="2"><span class="st-marker">○</span><span>AI အသံဖန်တီးနေသည်</span></div>
<div class="st-line" data-idx="3"><span class="st-marker">○</span><span>အသံကို စစ်ဆေးနေသည်</span></div>
</div>
...
<div class="card" id="srtLoadingCard" style="display:none;">
<div class="shop-loading-card">
<div class="spinner"></div>
<div class="shop-loading-title">&#10024; AI စာတန်းထိုးဖန်တီးနေသည်...</div>
<div class="shop-status-list" id="srtStatus">
<div class="st-line" data-idx="0"><span class="st-marker">○</span><span>အချက်အလက်များကို ဖတ်နေသည်</span></div>
<div class="st-line" data-idx="1"><span class="st-marker">○</span><span>အသံအကြောင်းအရာကို ခွဲခြမ်းနေသည်</span></div>
<div class="st-line" data-idx="2"><span class="st-marker">○</span><span>AI စာတန်းထိုးဖန်တီးနေသည်</span></div>
<div class="st-line" data-idx="3"><span class="st-marker">○</span><span>စာတန်းထိုးကို စစ်ဆေးနေသည်</span></div>
</div>
...
<div class="card" id="transLoadingCard" style="display:none;">
<div class="shop-loading-card">
<div class="spinner"></div>
<div class="shop-loading-title">&#10024; AI ဘာသာပြန်ဖန်တီးနေသည်...</div>
<div class="shop-status-list" id="transStatus">
<div class="st-line" data-idx="0"><span class="st-marker">○</span><span>စာသားများကို ဖတ်နေသည်</span></div>
<div class="st-line" data-idx="1"><span class="st-marker">○</span><span>ဘာသာပြန်အကြောင်းအရာကို ခွဲခြမ်းနေသည်</span></div>
<div class="st-line" data-idx="2"><span class="st-marker">○</span><span>ဘာသာပြန်ဖန်တီးနေသည်</span></div>
<div class="st-line" data-idx="3"><span class="st-marker">○</span><span>ဘာသာပြန်ကို စစ်ဆေးနေသည်</span></div>
</div>
...
const STEPS_HTML = STEP1_HTML + STEP2_HTML + STEP3_HTML;
...
.type-chip.locked{opacity:.4;cursor:not-allowed}
...
.srt-editable{width:100%;background:var(--bg-input);border:1px solid var(--border);border-radius:8px;padding:14px;color:var(--text);font-family:'Courier New',monospace;font-size:12.5px;line-height:1.6;resize:vertical;min-height:140px;margin-top:8px;box-sizing:border-box}
...
.shop-view-title{font-size:15px;font-weight:700;color:var(--text);display:flex;align-items:center;gap:8px}
/* ===== Content Result / Setup textarea (auto-expand) ===== */
.shop-result{width:100%;background:var(--bg-input);border:1px solid var(--border);border-radius:10px;padding:14px;color:var(--text);font-size:14px;line-height:1.7;font-family:inherit;resize:vertical;min-height:120px;box-sizing:border-box;overflow:hidden}
.shop-result:focus{outline:none;border-color:var(--cyan)}
/* ===== Branch Action Cards ===== */
.branch-action-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px;margin-top:6px}
.branch-action-card{background:linear-gradient(135deg,#111a2e,#0d1424);border:1px solid var(--border-strong);border-radius:16px;padding:22px 18px;text-align:center;cursor:pointer;transition:all .2s}
.branch-action-card:hover{transform:translateY(-2px);border-color:var(--cyan);box-shadow:0 6px 24px rgba(0,229,255,.15)}
.ba-icon{font-size:34px;margin-bottom:8px}
.ba-title{font-size:15px;font-weight:700;color:var(--text)}
.ba-sub{font-size:12px;color:var(--text2);margin-top:4px}
/* ===== Loading (status lines) ===== */
.shop-loading-card{text-align:center;padding:28px 16px}
.shop-loading-card .spinner{width:36px;height:36px;border-width:4px;margin:0 auto 16px}
.spinner{width:20px;height:20px;border:3px solid rgba(0,229,255,.2);border-top-color:#00e5ff;border-radius:50%;animation:spin .8s linear infinite;display:inline-block}
@keyframes spin{to{transform:rotate(360deg)}}
.shop-loading-title{font-size:17px;font-weight:700;color:var(--cyan);margin-bottom:18px}
.shop-status-list{max-width:440px;margin:0 auto;text-align:left}
.st-line{display:flex;align-items:center;gap:10px;padding:8px 12px;border-radius:10px;color:var(--text2);font-size:13.5px;opacity:.5;transition:all .2s}
...
.error-box{display:none;background:rgba(255,82,82,.1);border:1px solid rgba(255,82,82,.3);color:var(--error);padding:12px 16px;border-radius:8px;font-size:13px;margin-top:12px;line-height:1.7;white-space:pre-line;text-align:left}
.error-box.show{display:block}
.retry-row{display:none;justify-content:center;gap:10px;margin-top:16px;flex-wrap:wrap}
.retry-row.show{display:flex}
/* ===== Story Map (Video Result) ===== */
.story-map .sm-section{margin-top:22px}
.story-map .sm-section:first-child{margin-top:0}
.sm-section-title{display:flex;align-items:center;gap:10px;font-size:15px;font-weight:700;color:var(--text);margin-bottom:12px;padding-bottom:8px;border-bottom:1px solid var(--border)}
.sm-card{background:var(--bg-input);border:1px solid var(--border);border-radius:12px;padding:14px 16px;margin-bottom:14px}
.sm-card-head{display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:8px}
.sm-card-name{font-weight:700;color:var(--cyan);font-size:14px}
.sm-id{font-size:10.5px;color:var(--purple);background:rgba(123,92,255,.12);border:1px solid rgba(123,92,255,.3);padding:2px 10px;border-radius:20px;font-family:'Courier New',monospace;word-break:break-all}
.sm-lbl{font-size:11.5px;color:var(--text2);font-weight:700;letter-spacing:.4px;margin:10px 0 6px;text-transform:uppercase}
.sm-txt{white-space:pre-wrap;line-height:1.6;background:var(--bg-card);padding:10px 12px;border-radius:8px;font-size:13px;word-break:break-word}
.sm-meta{display:flex;flex-wrap:wrap;gap:6px 18px;font-size:12.5px;color:var(--text2);padding:8px 0;margin-bottom:4px}
.sm-meta-item{display:inline-flex;align-items:center;gap:5px}
.sm-meta-item b{color:var(--text);font-weight:600}
.sm-scene{position:relative;padding:0 0 22px 26px;margin-left:6px;border-left:2px solid rgba(123,92,255,.35)}
.sm-scene:last-child{border-left-color:transparent;padding-bottom:0}
.sm-scene::before{content:'';position:absolute;left:-7px;top:4px;width:12px;height:12px;border-radius:50%;background:var(--purple);box-shadow:0 0 0 3px rgba(123,92,255,.15)}
.sm-scene-head{display:flex;justify-content:space-between;align-items:center;gap:10px;flex-wrap:wrap;margin-bottom:6px}
.sm-scene-title{font-weight:700;color:var(--purple);font-size:14.5px}
.sm-box{margin-top:10px}
.shop-gen-img{width:100%;max-width:420px;border-radius:8px;border:1px solid var(--border);margin-top:8px;display:block}
/* ===== Audio ===== */
.audio-player-row{display:flex;align-items:center;gap:12px;flex-wrap:wrap;margin-top:4px}
.audio-player-row audio{flex:1;min-width:220px;margin-top:0}
.audio-info{font-size:12.5px;color:var(--text2);margin-top:10px}
/* ===== Translation (line-by-line) ===== */
.trans-view{margin-top:10px}
.trans-pair{background:var(--bg-input);border:1px solid var(--border);border-radius:10px;padding:10px 14px;margin-bottom:10px}
.trans-ts{font-size:11px;color:var(--text3);font-family:'Courier New',monospace;margin-bottom:6px}
.trans-src{font-size:13.5px;color:var(--cyan);line-height:1.6;word-break:break-word}
.trans-out{font-size:13.5px;color:var(--success);line-height:1.6;margin-top:4px;padding-top:4px;border-top:1px dashed rgba(0,230,118,.2);word-break:break-word}
.dir-radio{display:inline-flex;align-items:center;gap:6px;background:var(--bg-input);border:1px solid var(--border);border-radius:20px;padding:8px 14px;font-size:12.5px;color:var(--text2);cursor:pointer;user-select:none}
...
.shop-view-title{font-size:13.5px}
.card{padding:14px}
}
</style>
</head>
...
function showAudioPhase(){
  ...
  document.getElementById('srtLoadingCard').style.display=shopState.audio.step===4?'':'none';
  document.getElementById('srtResultCard').style.display=shopState.audio.step===5?'':'none';
  document.getElementById('transLoadingCard').style.display=shopState.audio.step===6?'':'none';
