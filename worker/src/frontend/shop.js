...
const STEPS = [
  { label: 'Product', sub: 'Product info' },
  { label: 'Goal', sub: 'Type & generate', req: [] },
  { label: 'Content', sub: 'Edit & revise', req: [2] },
  { label: 'Voice', sub: 'TTS & SRT', req: [] },
  { label: 'Video', sub: 'Visual & final', req: [] },
];
