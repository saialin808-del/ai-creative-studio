...
const STEPS = [
  ...
  { label: 'Content', sub: 'AI output', req: [1] },
  { label: 'Edit', sub: 'Revise & polish', req: [2] },
  { label: 'Voice / Format', sub: 'TTS · SRT · Translate', req: [2] },
  { label: 'Video Plan', sub: 'Scenes & characters', req: [1] },
  { label: 'Result', sub: 'Final output', req: [2] },
];
