...
.main-content{margin-left:220px;padding:24px;max-width:960px;}
...
<nav class="sidebar" id="sidebar">
  ...
  <a class="nav-item active" href="/app"><span class="nav-icon-circle">🏠</span> Home</a>
  ...
  <a class="nav-item" href="/app/creations"><span class="nav-icon-circle">📁</span> Recent Projects</a>
